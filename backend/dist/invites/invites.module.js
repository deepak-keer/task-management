...
exports.InvitesModule = InvitesModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: invite_link_schema_1.InviteLink.name, schema: invite_link_schema_1.InviteLinkSchema }])],
        controllers: [invites_controller_1.InvitesController],
        providers: [invites_service_1.InvitesService],
        exports: [invites_service_1.InvitesService, mongoose_1.MongooseModule],
    })
], InvitesModule);
